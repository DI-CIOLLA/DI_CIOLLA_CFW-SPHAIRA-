...
void App::DisplayInstallOptions(bool left_side) {
    ...
    install_items.push_back("SD-CARD"_i18n);
...
void App::DisplayFtpOptions(bool left_side) {
    ...
    options->Add<ui::SidebarEntryBool>(
        ...
        "Shows the SD-CARD ALBUM folder."_i18n
    );
    ...
    options->Add<ui::SidebarEntryBool>(
        "Show SD-CARD contents"_i18n, App::GetApp()->m_ftp_show_content_sd,
        i18n::get("microsd_contents_info",
            "Shows the SD-CARD contents folder.\n\n"
            "NOTE: This is not the normal SD-CARD storage, it is instead "
            "the location where NCA's are stored. The normal SD-CARD is always mounted."
        )
    );
...
void App::DisplayMtpOptions(bool left_side) {
    ...
    options->Add<ui::SidebarEntryBool>(
        "Show SD-CARD contents"_i18n, App::GetApp()->m_mtp_show_content_sd,
        i18n::get("microsd_contents_info",
            "Shows the SD-CARD contents folder.\n\n"
            "NOTE: This is not the normal SD-CARD storage, it is instead "
            "the location where NCA's are stored. The normal SD-CARD is always mounted."
